...
public class SqlServerOrleansDataSeeder : IOrleansDataSeeder
{
    protected ICurrentTenant CurrentTenant { get; }
    protected IRepository<OrleansQuery> OrleansQueryRepository { get; }

    public SqlServerOrleansDataSeeder(
    ...
    public async Task SeedAsync(string databaseProvider, Guid? tenantId = null)
    {
