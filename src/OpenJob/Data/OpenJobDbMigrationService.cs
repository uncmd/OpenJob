...
public class OpenJobDbMigrationService : ITransientDependency
{
    public ILogger<OpenJobDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly OpenJobEFCoreDbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public OpenJobDbMigrationService(
        IDataSeeder dataSeeder,
        OpenJobEFCoreDbSchemaMigrator dbSchemaMigrator,
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "OpenJob");
    }
