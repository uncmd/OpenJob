...
public class OpenJobDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    protected IGuidGenerator GuidGenerator { get; }
    protected ICurrentTenant CurrentTenant { get; }
    protected IRepository<OrleansQuery> OrleansQueryRepository { get; }
    protected IRepository<JobInfo, Guid> JobRepository { get; }
    protected IRepository<TaskInfo, Guid> TaskRepository { get; }

    public OpenJobDataSeedContributor(
