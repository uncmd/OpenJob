...
public static class OpenJobDbContextModelBuilderExtensions
{
    public static void ConfigureOpenJob(this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(OpenJobDbProperties.DbTablePrefix + "AppInfo", OpenJobDbProperties.DbSchema);
        ...
        {
            b.ToTable(OpenJobDbProperties.DbTablePrefix + "JobInfo", OpenJobDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(OpenJobDbProperties.DbTablePrefix + "TaskInfo", OpenJobDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(OpenJobDbProperties.DbTablePrefix + "WorkerInfo", OpenJobDbProperties.DbSchema);
            b.ConfigureByConvention();
