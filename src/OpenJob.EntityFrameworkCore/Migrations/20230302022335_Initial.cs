    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpenJobAppInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpenJobJobInfo", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OpenJobTaskInfo",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    JobArgs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TaskArgs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpenJobTaskInfo", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OpenJobWorkerInfo",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Labels = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    CpuProcessors = table.Column<int>(type: "int", nullable: false),
                    CpuLoad = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpenJobWorkerInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "DATETIME2(3)", precision: 3, nullable: false, defaultValue: new DateTime(2023, 3, 2, 2, 23, 34, 657, DateTimeKind.Utc).AddTicks(5118)),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpenJobAppInfo_Name",
                table: "OpenJobAppInfo",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OpenJobJobInfo_AppId",
                table: "OpenJobJobInfo",
                column: "AppId");

            migrationBuilder.CreateIndex(
                name: "IX_OpenJobJobInfo_Name",
                table: "OpenJobJobInfo",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_OpenJobJobInfo_NextTriggerTime",
                table: "OpenJobJobInfo",
                column: "NextTriggerTime");

            migrationBuilder.CreateIndex(
                name: "IX_OpenJobTaskInfo_AppId",
                table: "OpenJobTaskInfo",
                column: "AppId");

            migrationBuilder.CreateIndex(
                name: "IX_OpenJobTaskInfo_ExpectedTriggerTime",
                table: "OpenJobTaskInfo",
                column: "ExpectedTriggerTime");

            migrationBuilder.CreateIndex(
                name: "IX_OpenJobTaskInfo_JobId",
                table: "OpenJobTaskInfo",
                column: "JobId");
